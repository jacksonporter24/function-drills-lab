...
//what is phrase for just one parameter? 
...
console.log(exclaimTwo('hello, jackson'))
...
let oddChecker = thatsOdd(17852399)
...
// const bestMovie = (item) => {
//   let movieTitle = item()
//   return movieTitle (item + "is the best movie ever!')
// }
// console.log(movieTitle('Knives Out'))
